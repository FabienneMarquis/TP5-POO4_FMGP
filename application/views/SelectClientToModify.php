<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#submit").click(function (event) {
            ...
            window.location.replace("<?php echo base_url(); ?>" + "index.php/Controller/ModifyClient/"+$("#code").val());
        });
...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="post" action="<?php echo base_url() ?>index.php/Controller/ModifyClient" role="form" class="form-horizontal">
